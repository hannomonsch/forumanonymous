...
require_once($CFG->dirroot . '/mod/forumanonymous/backup/moodle2/backup_forum_stepslib.php'); // Because it exists (must)
require_once($CFG->dirroot . '/mod/forumanonymous/backup/moodle2/backup_forum_settingslib.php'); // Because it exists (optional)
...
class backup_forum_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new backup_forum_activity_structure_step('forumanonymous structure', 'forumanonymous.xml'));
    }
