...
/**
 * Strings for component 'forumanonymous', language 'de', branch 'MOODLE_22_STABLE'
 *
...
$string['configanonuser'] = 'Anzeigename des anonymen Users.';

$string['activityoverview'] = 'Es sind neue posts im Forum vorhanden';
...
$string['allforumanonymouss'] = 'Alle anonymen Foren';
...
$string['blockafter_help'] = 'Diese Zahl legt fest, wie viele Beiträge pro Nutzer/in im angegebenen Zeitfenster maximal ins Forum eingetragen werden dürfen. Nutzer/innen mit der Berechtigung mod/forumanonymous:postwithoutthrottling sind von einer Sperre ausgenommen.';
$string['blockperiod'] = 'Zeitfenster';
$string['blockperioddisabled'] = 'Nicht sperren';
$string['blockperiod_help'] = 'In diesem Zeitfenster dürfen maximal so viele Beiträge pro Nutzer/in ins Forum eingetragen werden, wie mit der Zahl \'Sperre\' festgelegt sind. Nutzer/innen mit der Berechtigung mod/forumanonymous:postwithoutthrottling sind von einer Sperre ausgenommen.';
$string['blogforumanonymous'] = 'Anonymes Standardforum, angezeigt in blog-ähnlichem Format';
...
$string['cannotaddteacherforumanonymousto'] = 'Die konvertierte Instanz des anonymen Trainerforums konnte nicht im Kursabschnitt 0 eingefügt werden.';
$string['cannotcreatediscussion'] = 'Die neue Diskussion konnte nicht erstellt werden.';
$string['cannotcreateinstanceforteacher'] = 'Die neue Kursinstanz für das anonyme Trainerforum konnte nicht erstellt werden.';
$string['cannotdeleteforumanonymousmodule'] = 'Sie dürfen das Forenmodul nicht löschen.';
...
$string['cannotfindorcreateforumanonymous'] = 'Das anonyme Nachrichtenforum dieser Website wurde nicht gefunden oder konnte nicht angelegt werden';
$string['cannotfindparentpost'] = 'Der erste Beitrag zu diesem Thema {$a} wurde nicht gefunden';
$string['cannotmovefromsingleforumanonymous'] = 'Die Diskussion kann nicht aus einem einfachen anonymen Einzeldiskussionsforum verschoben werden';
...
$string['cannotmovetonotfound'] = 'Das anonyme Zielforum wurde nicht im Kurs gefunden.';
$string['cannotmovetosingleforumanonymous'] = 'Das Thema kann nicht ein anonymes Einzeldiskussionsforum verschoben werden';
...
$string['discussionmovedpost'] = 'Dieses Thema wurde verschoben nach <a href="{$a->discusshref}">hier</a> ins Forum <a href="{$a->forumanonymoushref}">{$a->forumanonymousname}</a>';
...
$string['displaystart_help'] = 'Die Einstellung legt fest, ob ein Forumsbeitrag erst ab einem bestimmten Datum angezeigt werden soll. Beachten Sie, dass Administrator/innen die Beiträge immer sehen dürfen.';
$string['eachuserforumanonymous'] = 'Jede Person darf genau ein Thema anlegen';
$string['edit'] = 'Bearbeiten';
$string['editedby'] = 'Bearbeitet von {$a->name} - Originaleintrag am {$a->date}';
$string['editedpostupdated'] = '{$a}\'s post wurde aktualisiert';
...
$string['forumanonymous'] = 'Forum';
$string['forum:addinstance'] = 'Ein neues Forum hinzufügen';
$string['forumanonymous:addnews'] = 'Nachrichten hinzufügen';
$string['forum:allowforcesubscribe'] = 'Erlaube erzwungene Einschreibung ins Forum';
$string['forumanonymous:addquestion'] = 'Frage hinzufügen';
$string['forumanonymousauthorhidden'] = 'Autor/in (verborgen)';
$string['forumanonymousblockingalmosttoomanyposts'] = 'Sie erreichen bald die Höchstzahl der zulässigen Beiträge. Sie haben {$a->numposts} Beiträge im Zeitraum {$a->blockperiod} veröffentlicht. Die Grenze ist bei {$a->blockafter} Beiträgen erreicht.';
$string['forumbodyhidden'] = 'Dieser post kann von Ihnen nicht eingesehen werden, wahrscheinlich weil Sie nicht an der Diskussion teilgenommen haben, die maximale Bearbeitungszeit abgelaufen ist, die Diskussion noch nicht gestartet oder bereist beendet worden ist.';
$string['forumanonymousbodyhidden'] = 'Sie können diesen Beitrag nicht ansehen. Entweder haben Sie selber in dieser Diskussion noch nichts geschrieben oder die Bearbeitungszeit für den Beitrag läuft noch.';
$string['forumanonymous:createattachment'] = 'Anhänge hinzufügen';
$string['forumanonymous:deleteanypost'] = 'Alle Beiträge löschen (jederzeit)';
$string['forumanonymous:deleteownpost'] = 'Eigene Beiträge löschen (mit Zeitbegrenzung)';
$string['forumanonymous:editanypost'] = 'Alle Beiträge bearbeiten';
$string['forumanonymous:exportdiscussion'] = 'Gesamtes Thema exportieren';
$string['forumanonymous:exportownpost'] = 'Eigenen Beitrag exportieren';
$string['forumanonymous:exportpost'] = 'Beitrag exportieren';
$string['forumanonymousintro'] = 'Einführung';
$string['forumanonymous:managesubscriptions'] = 'Abonnent/innen verwalten';
$string['forumanonymous:movediscussions'] = 'Themen verschieben';
$string['forumanonymousname'] = 'Forumsname';
$string['forumanonymousposts'] = 'Forumsbeiträge';
$string['forumanonymous:postwithoutthrottling'] = 'Keine Sperre bei zu vielen Beiträgen';
$string['forumanonymous:rate'] = 'Beiträge bewerten';
$string['forumanonymous:replynews'] = 'Auf Nachrichten antworten';
$string['forumanonymous:replypost'] = 'Auf Beiträge antworten';
$string['forumanonymouss'] = 'Foren';
$string['forumanonymous:splitdiscussions'] = 'Themen aufteilen';
$string['forumanonymous:startdiscussion'] = 'Neue Themen beginnen';
$string['forumanonymoussubjecthidden'] = 'Betreff (verborgen)';
$string['forumanonymous:throttlingapplies'] = 'Beiträge beschränken';
$string['forumanonymoustracked'] = 'Ungelesene Beiträge werden verfolgt';
$string['forumanonymoustrackednot'] = 'Ungelesene Beiträge werden nicht verfolgt';
$string['forumanonymoustype'] = 'Forumstyp';
$string['forumanonymoustype_help'] = 'Es gibt fünf verschiedene Forentypen:
...
* Standardforumanonymous in einem blog-ähnlichen Anzeigeformat - offenes Forum, in dem jeder zu jeder Zeit ein neues Diskussionsthema eröffnen und auf alle Beiträge antworten kann. Bei diesem Forum werden alle Themen auf einer Seite zusammen mit Links "Dieses Thema diskutieren" gezeigt.
* Standardforumanonymous - ein offenes Forum, in dem jeder zu jeder Zeit ein neues Diskussionsthema eröffnen und auf alle Beiträge antworten kann.
';
$string['forumanonymous:addinstance'] = 'Füge ein neues anonymes Forum hinzu';
$string['forumanonymous:myaddinstance'] = 'Füge ein neues anonymes Forum meiner Moodle-Seite hinzu';
$string['forumanonymous:viewallratings'] = 'Alle Teilwertungen sehen';
$string['forumanonymous:viewanyrating'] = 'Alle Gesamtwertungen sehen';
$string['forumanonymous:viewdiscussion'] = 'Themen sehen';
$string['forumanonymous:viewhiddentimedposts'] = 'Verborgene zeitliche Beiträge sehen';
$string['forumanonymous:viewqandawithoutposting'] = 'Frage- und Antwortbeiträge immer sehen';
$string['forumanonymous:viewrating'] = 'Eigene Gesamtwertung sehen';
$string['forumanonymous:viewsubscribers'] = 'Abonnentenliste sehen';
$string['generalforumanonymous'] = 'Anonymes Standardforum zur allgemeinen Nutzung';
$string['generalforumanonymouss'] = 'Allgemeines Forum';
...
$string['invalidforumanonymousid'] = 'Falsche Foren-ID';
...
$string['learningforumanonymouss'] = 'Lernforen';
...
$string['modulename'] = 'Forum anonym';
$string['modulename_help'] = 'Diese Lernaktivität ermöglicht zwischen Ihnen und Ihren Studierenden 
		oder den Studierenden untereinander eine asynchrone, anonymisierte Diskussion. 
		Mit Ausnahme der Lehrenden werden die Teilnehmenden einer Diskussion dabei nicht mit Namen aufgeführt. ';
$string['modulenameplural'] = 'Foren anonym';
$string['more'] = 'mehr';
$string['movedmarker'] = '(Verschoben)';
$string['movethisdiscussionto'] = 'Dieses Thema verschieben nach ...';
$string['mustprovidediscussionorpost'] = 'Für den Export müssen Sie entweder eine Themen-ID oder eine Nachrichten-ID angeben';
$string['namenews'] = 'Anonyme Nachrichtenforum';
$string['namenews_help'] = 'Das Nachrichtenforum ist ein spezielles Forum für Ankündigungen, welches automatisch von Moodle in jedem Kurs und auch der Startseite generiert wird. Ausschließlich Trainer/innen und Administrator/innen dürfen im Nachrichtenforumanonymous schreiben. Pro Kurs kann es nur ein Nachrichtenforumanonymous geben. Im Block "Neue Nachrichten" werden die aktuelle Beiträge angezeigt. ';
$string['namesocial'] = 'Soziales Forum';
$string['nameteacher'] = 'Anonymes Trainerforum';
$string['newforumanonymousposts'] = 'Neue Forenbeiträge';
...
$string['nopostforumanonymous'] = 'In diesem Forum können Sie keine Beiträge veröffentlichen';
...
$string['notpartofdiscussion'] = 'Dieser Beitrag ist kein Teil einer Diskussion!';
$string['notrackforumanonymous'] = 'Ungelesene Beiträge nicht markieren';
...
$string['nownotsubscribed'] = '{$a->name} wird künftig KEINE Kopien von \'{$a->forumanonymous}\' per E-Mail erhalten.';
$string['nownottracking'] = '{$a->name} will \'{$a->forumanonymous}\' nicht weiter verfolgen.';
$string['nowsubscribed'] = '{$a->name} wird künftig Kopien von \'{$a->forumanonymous}\'  per E-Mail erhalten.';
$string['nowtracking'] = '{$a->name} verfolgt nun das \'{$a->forumanonymous}\'.';
...
$string['page-mod-forumanonymous-discuss'] = 'Forumsdiskussionsseite
';
$string['page-mod-forumanonymous-view'] = 'Forumshauptseite';
$string['page-mod-forumanonymous-x'] = 'Jede Forumsseite';
...
$string['pluginname'] = 'Anonymes Forum';
...
$string['posttoforumanonymous'] = 'Beitrag absenden';
...
$string['qandaforumanonymous'] = 'Frage-Antwort-Forum';
...
$string['replyforumanonymous'] = 'Antwort ins Forum';
$string['replytouser'] = 'E-Mail-Adresse in Antwort verwenden';
$string['resetforumanonymouss'] = 'Beiträge entfernen von';
$string['resetforumanonymoussall'] = 'Alle Beiträge löschen';
...
$string['searchforumanonymousintro'] = 'Tragen Sie die Suchbegriffe in einem oder mehreren Feldern ein:';
$string['searchforumanonymouss'] = 'Suche in Foren';
...
$string['searchwhichforumanonymouss'] = 'Forum für Suche auswählen';
...
$string['singleforumanonymous'] = 'Diskussion zu einem einzigen Thema';
$string['smallmessage'] = '{$a->user} schrieb in {$a->forumanonymousname}';
...
$string['thisforumanonymousisthrottled'] = 'Für dieses Forum ist eine Höchstzahl von Beiträgen innerhalb eines bestimmten Zeitraums festgelegt worden. Dies gilt nach {$a->blockafter} Beiträgen innerhalb von {$a->blockperiod}';
$string['timedposts'] = 'Zeitgesteuerte Beiträge';
$string['timestartenderror'] = 'Der Endtermin kann nicht vor dem Starttermin liegen.';
$string['trackforumanonymous'] = 'Ungelesene Beiträge markieren';
...
* Optional - Teilnehmer/innen können die Markierung ein- oder ausschalten
