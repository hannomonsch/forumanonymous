...
function forumanonymous_produce_subscribe_link(forumanonymousid, backtoindex, ltext, ltitle) {
    var elementid = "subscriptionlink";
    var subs_link = document.getElementById(elementid);
    if(subs_link){
        subs_link.innerHTML = "<a title='"+ltitle+"' href='"+M.cfg.wwwroot+"/mod/forumanonymous/subscribe.php?id="+forumanonymousid+backtoindex+"&amp;sesskey="+M.cfg.sesskey+"'>"+ltext+"<\/a>";
    }
}

function forumanonymous_produce_tracking_link(forumanonymousid, ltext, ltitle) {
    var elementid = "trackinglink";
    var subs_link = document.getElementById(elementid);
    if(subs_link){
        subs_link.innerHTML = "<a title='"+ltitle+"' href='"+M.cfg.wwwroot+"/mod/forumanonymous/settracking.php?id="+forumanonymousid+"'>"+ltext+"<\/a>";
    }
}
